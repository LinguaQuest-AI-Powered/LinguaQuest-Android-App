...
class SetActiveLanguageUseCase @Inject constructor(
    private val languagesRepo: LanguagesRepo
) {
    suspend operator fun invoke(languageId: Int): LinguaQuestResult<UserLanguage, LinguaQuestDataError> =
        languagesRepo.setActiveLanguage(languageId)
}
