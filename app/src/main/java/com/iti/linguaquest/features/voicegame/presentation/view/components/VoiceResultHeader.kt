...
fun VoiceResultHeader(
    ...
    AppMascotGradientBox(
        ...
        Text(
            if (isPassed) stringResource(R.string.voice_result_great_job) else stringResource(R.string.voice_result_not_quite),
        ...
        if (isPassed && coinsAwarded > 0) {
            ...
            AnimatedVisibility(visible = !hideCoinsBadge, exit = fadeOut()) {
                Text(
