...
import com.iti.linguaquest.features.auth.data.datasource.local.AuthCacheDataSourceImpl
...
abstract class AuthModule {
    ...
    @Binds
    @Singleton
    abstract fun bindAuthCacheDataSource(
        impl: AuthCacheDataSourceImpl
    ): AuthCacheDataSource
}